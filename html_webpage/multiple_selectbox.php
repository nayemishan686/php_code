    ...
    <div class="container">
        ...
        <p>
            <?php 
                ...
                $lname = '';
                $checked = '';
                $fruits = ['apple', 'mango','banana','orange','coconut'];
                $selected = '';
    ...
    <div class="container">
        <div class="row">
            <form action="" method="post">
                ...
                <select name="fruits[]" id="fruits" class="form-select mt-3 h-50" multiple>
                    <option value="" selected disabled>Select some fruits</option>
                    <?php multipleOptionSelect($fruits); ?>
